...
class ScheduleView3 extends StatefulWidget {
  ScheduleView3({Key? key}) : super(key: key);
  @override
  ScheduleView3State createState() => ScheduleView3State();
}

class ScheduleView3State extends State<ScheduleView3> {
  @override
